...
2026-07-27 — HEAD `04d1769` on `main` (toolchain pin; CI GREEN on 3.11/3.12/3.13) + this `[skip ci]` doc-sync. G8 guard = `70258a5`. Tree clean, in sync with origin. Deep pre-2026-07-25 history in `git log` / `decisions.md` / `LESSONS_LEARNED.md` / `docs/security-audits/`.
