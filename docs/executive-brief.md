...
**Status:** Production-ready · Phases 1–7 complete · PyPI publish pending
...
**Skill system** — 15 research skills ship with the package. New skills are plain Markdown files; no code changes required to add capabilities.
...
**MCP server** — The skill registry is exposed as an MCP server (`adv-multi-agent-skills`), making all 15 research skills available as tools directly inside Claude Code with one registration command.
...
| Test coverage | 160 tests, mypy strict, ruff clean | ✅ Complete |
